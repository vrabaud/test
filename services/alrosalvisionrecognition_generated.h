...
#ifndef ALROS_ALROSALVISIONRECOGNITION_GENERATED_H
#define ALROS_ALROSALVISIONRECOGNITION_GENERATED_H
...
#include <rosbridge/ALVisionRecognitionLoad.h>
#include <rosbridge/ALModulePing.h>
#include <rosbridge/ALVisionRecognitionRun.h>
...
#include "alrosalvisionrecognition_h.inc"
...
namespace AL {
  ...
  class ALRosALVisionRecognition {
    public:
...
// non generated code included
#include "alrosalvisionrecognition_h_declarations.inc"

      private:
        ALPtr<ALVisionRecognitionProxy> fProxy;
        std::vector<ros::ServiceServer> fServices;
    };
}
#endif // ALROS_ALROSALVISIONRECOGNITION_GENERATED_H

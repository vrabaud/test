...
#ifndef ALROS_ALROSALPREFERENCES_GENERATED_H
#define ALROS_ALROSALPREFERENCES_GENERATED_H
...
#include "alrosalpreferences_h.inc"
...
// non generated code included
#include "alrosalpreferences_h_declarations.inc"

      private:
        ALPtr<ALPreferencesProxy> fProxy;
        std::vector<ros::ServiceServer> fServices;
    };
}
#endif // ALROS_ALROSALPREFERENCES_GENERATED_H

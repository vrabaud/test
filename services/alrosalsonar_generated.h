...
#ifndef ALROS_ALROSALSONAR_GENERATED_H
#define ALROS_ALROSALSONAR_GENERATED_H
...
// non generated code included
#include "alrosalsonar_h_declarations.inc"

      private:
        ALPtr<ALSonarProxy> fProxy;
        std::vector<ros::ServiceServer> fServices;
    };
}
#endif // ALROS_ALROSALSONAR_GENERATED_H

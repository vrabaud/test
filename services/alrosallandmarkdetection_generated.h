...
#ifndef ALROS_ALROSALLANDMARKDETECTION_GENERATED_H
#define ALROS_ALROSALLANDMARKDETECTION_GENERATED_H
...
#include <rosbridge/ALLandMarkDetectionRun.h>
...
#include "alrosallandmarkdetection_h.inc"
...
namespace AL {
  ...
  class ALRosALLandMarkDetection {
    public:
...
// non generated code included
#include "alrosallandmarkdetection_h_declarations.inc"

      private:
        ALPtr<ALLandMarkDetectionProxy> fProxy;
        std::vector<ros::ServiceServer> fServices;
    };
}
#endif // ALROS_ALROSALLANDMARKDETECTION_GENERATED_H
